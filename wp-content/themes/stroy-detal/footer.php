        ...
        <div class="container">
            <div class="footer__grid">
                <div class="footer__grid-info">
                    <div class="footer__grid-info_logo">
                        <a href="#">Строй-Деталь.рф</a>
                        <p>Строительство качественных домовв Костроме и Костромской области</p>
                    </div>
                    <div class="footer__grid-info_hours">
                        <p>Часы работы:</p>
                        <p>Пн-Вс с 9:00 до 18:00 без выходных</p>
                    </div>
                    <div class="footer__grid-info_info">
                        <p>ИП Филиппов Дмитрий Сергеевич</p>
                        <p>ИНН: 440116275339</p>
                        <p>ОГРН: 322440000004062</p>
                    </div>
                </div>
                <div class="footer__grid-menu">
                    <p class="footer__grid-menu__title">
                        Меню
                    </p>
                    <ul>
                        <li>
                ...
                <div class="footer__grid-contacts">
                    <p class="footer__grid-contacts__title">
                        Контакты
                    </p>
                    <ul>
                        <li>
